...
router.post('/store', function(req, res, next) {
    ...
    connection.query('insert into kategori set ?', Data, function(err, result) { if (err) {
...
router.get('/edit/(:id)', function(req, res, next){
    ...
    connection.query('select * from kategori where id_kategori = '+ id, function(err, rows, fields) {
        if(err) {
...
router.post('/update/(:id)', function(req, res, next) { 
    ...
    connection.query('update kategori set? where id_kategori = ' + id, Data, function(err) {
        if (err) {
            ...
            req.flash('success', 'Berhasil memeperbarui data!');
        }
    res.redirect('/kategori');
    })
}catch {
